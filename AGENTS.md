...
Architecture decisions live in `docs/adr/`. Glossary is `CONTEXT.md`. Product spec is `docs/prd.md`. Human launch work (ONNX, Unkey, MPP, BR25, AWS) is `docs/LAUNCH.md`.
